...
################# TODO: import this stuff and law list to mongodb? (since automod only blocks msgs/restricts users (and because of that .listen() cant track messages and kick users)) ##################
help_dict = {
